...
export const messages = {
  en: {
    app: {
      ...
      updateRestartFailed: "Update installed. Restart the app to finish.",
      upToDate: "You are on the latest version.",
      updatesDesktopOnly: "Update checks run in the desktop app.",
      updateCheckFailed: "Could not check for updates: {{message}}",
      updateInstallFailed: "Could not install update: {{message}}",
    },
    pages: {
      home: "Home",
      about: "About",
  ...
  de: {
    app: {
      ...
      updates: "Updates",
      checkUpdates: "Pruefen",
      checkingUpdates: "Suche nach Updates...",
      installUpdate: "Update installieren",
      updateAvailable: "Version {{version}} ist verfuegbar.",
      updateDownloading: "Update wird geladen...",
      updateInstalling: "Update wird installiert...",
      updateReady: "Update installiert. Neustart...",
      updateRestartFailed: "Update installiert. Starte die App neu, um abzuschliessen.",
      upToDate: "Du nutzt die neueste Version.",
      updatesDesktopOnly: "Update-Pruefungen laufen in der Desktop-App.",
      updateCheckFailed: "Update-Pruefung fehlgeschlagen: {{message}}",
      updateInstallFailed: "Update-Installation fehlgeschlagen: {{message}}",
    },
    pages: {
      home: "Start",
      about: "Info",
